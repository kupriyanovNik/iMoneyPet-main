...
public struct BarChartView : View {
    ...
    public var title: String = NSLocalizedString("expenses", comment: "")
    public var legend: String = "По категориям"
    public var style: ChartStyle = ChartStyle(
    ...
    public var darkModeStyle: ChartStyle = ChartStyle(
        backgroundColor: Color.white,
        accentColor: Colors.GradientNeonBlue,
        secondGradientColor: Colors.GradientPurple,
        textColor: Color.black,
        legendTextColor: Color.gray,
        dropShadowColor: Color.gray)
    public var formSize: CGSize = CGSize(width:180, height:240)
    public var dropShadow: Bool = false
    public var cornerImage: Image = Image(systemName: "waveform.path.ecg")
    public var valueSpecifier: String = "%.1f"
    public var animatedToBack: Bool = true
