...
public struct BarChartView : View {
    ...
    public init(data:ChartData, title: String, legend: String? = nil, style: ChartStyle, form: CGSize?, dropShadow: Bool? = true, cornerImage:Image? = Image(systemName: "waveform.path.ecg"), valueSpecifier: String? = "%.0f", animatedToBack: Bool = false){
        self.data = data
        self.title = title
        self.legend = legend
        self.style = style
